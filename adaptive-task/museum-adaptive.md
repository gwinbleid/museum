...
- Секция `Contacts`
- Блок `footer`
4. Ни на одном из разрешений до 320px включительно не появляется горизонтальная полоса прокрутки
5. Совмещается адаптивная и респонсивная (резиновая) вёрстка
...
- карты
6. На ширине экрана 1024рх и меньше реализовано адаптивное меню
...
7. Оптимизация скорости загрузки страницы
Оптимизация скорости загрузки страницы определяется при помощи сервиса https://developers.google.com/speed/pagespeed/insights/. Результат проверки скорости сайта  для мобильных устройств: 
   ...
   - 50 to 89 (orange): Needs Improvement - частично выполнено
   - 90 to 100 (green): Good - выполнено полностью
